...
namespace App\ModelExtensions\Translatable;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Relations\Relation;
use Illuminate\Database\Query\Builder as QueryBuilder;
use App\Exceptions\LocalesNotDefinedException;
...
trait Translatable
{
    ...
    */
    ...
    |
    */
    protected $configUseFallback = true;
    ...
    |
     */
    protected $configUsePropertyFallback = true;
    ...
    |
    */
    protected $configFallbackLocale = 'en';
    ...
    |
     */
    protected $configToArrayAlwaysLoadsTranslations = true;
    ...
    {
        return $this->configUsePropertyFallback;
    }
    ...
    private function getFallbackLocale($locale = null)
    {
        ...
        return $this->configFallbackLocale;
    }
    ...
    {
        $localesConfig = $this->configLocales;
    ...
    {
        return $this->configToArrayAlwaysLoadsTranslations;
    }
}